...
from dueling_ddqn_network import Dueling_DQN

class Dueling_DDQNAgent(object):
	def __init__(self, gamma, epsilon, lr, n_actions, input_dims, mem_size,
		...
		self.q_eval = Dueling_DQN(self.lr, self.n_actions, input_dims=self.input_dims,
									name=self.env_name+'_'+self.algo+'_q_eval', chkpt_dir=self.chkpt_dir)

		self.q_next = Dueling_DQN(self.lr, self.n_actions, input_dims=self.input_dims,
